                            ...
                            <tbody id="pelayanan-diagnosa9-list" class="table-form">
                                <c:forEach var="dp" items="${pelayananModel.diagnosa9}" varStatus="loop">
                                    <tr id="diagnosa9_${loop.index+1}">
                                        <td data-used="1" data-save="1" data-name="diagnosa9Tanggal" data-kolom-id="diagnosa9Tanggal"><fmt:formatDate value="${dp.diagnosa9Tanggal}" pattern="yyyy-MM-dd HH:mm" /></td>
