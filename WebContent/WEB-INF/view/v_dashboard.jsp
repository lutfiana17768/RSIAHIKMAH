...
<body>
						...
						<nav class="menu">
							<ul class="sidebar-menu metismenu" id="sidebar-menu">
                                ...
                                <li>
                                    ...
                                    <ul class="sidebar-nav">
                                        <li>
                                            <a href="/com.rsia.modura/Kelas/tambah"> Kelas </a>
                                        </li>
                                        <li>
                                            <a href="/com.rsia.modura/Agama/tambah"> Agama </a>
                                        </li>
                                        <li>
                                            <a href="/com.rsia.modura/Pasien/tambah"> Pasien </a>
                                        </li>
                                        <li>
                                            <a href="/com.rsia.modura/Tindakan/tambah"> Tindakan </a>
                                        </li>
                                        <li>
                                            <a href="v_paket.html"> Paket </a>
                                        </li>
                                        <li>
                                            <a href="v_ruangan.html"> Ruangan </a>
                                        </li>
                                        <li class="active">
                                            <a href="v_kamar.html"> Kamar </a>
                                        </li>
                                        <li>
                                            <a href="/com.rsia.modura/Kondisi/tambah"> Kondisi Pasien </a>
                                        </li>
                                        <li>
                                            <a href="/com.rsia.modura/Rujukan/tambah/"> Rujukan </a>
                                        </li>
                                        <li>
										...
										<li>
											<a href="/com.rsia.modura/jenis-pegawai/tambah">
		...
		<script src="../../META-INF/js/vendor.js"></script>
        <script src="../../META-INF/js/app.js"></script>
	</body>
</html>