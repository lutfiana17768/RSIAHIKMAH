                ...
                <section class="section">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-6">
                        <button type="button" class="btn btn-sm btn-success d_pasien-button" id="simpan-barang" style="float: right;">Update</button>
                            </div>
                        </div>
					<div class="container">
						<small>Keterangan : <span style="color:red">*</span> Wajib Diisi</small>
						...
						<div class="row card-block">
							<div class="col-6">
								<div class="form-group">
									...
									<form:select class="form-control boxed form-control-sm" path="barangJenisId" >
										<c:forEach var="temp" items="${jenisBarang}">
					                      <option value="${temp.barangJenisId }"> ${temp.barangJenisNama } </option>
						                </c:forEach>
									</form:select>
								</div>
