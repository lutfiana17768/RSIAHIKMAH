						...
						<div class="row sameheight-container">
							...
							<div class="col-md-6">
								<div class="card card-block sameheight-item">
									...
									<form role="form" action="http://localhost:8080/com.rsia.modura/provinsi/store" method="POST">
										...
										<div class="form-group">
											<label  for="form_control_1">Jenis Pegawai</label>
										...
										<div class="form-group">
											...
											<div class="select2-wrapper">
												<select class="form-control input-lg select2-single" dir="rtl" name="kota_lahir">
													<option></option>
										...
										<div class="form-group">
											...
											<div class="select2-wrapper">
												<select class="form-control input-lg select2-single" dir="rtl" name="nama_kota">
													<option></option>
													<c:forEach var="tempKota" items="${kota}">
				                                    	<option value=${tempKota.kotaKode }> ${tempKota.kotaNama } </option>
				                                    </c:forEach>
