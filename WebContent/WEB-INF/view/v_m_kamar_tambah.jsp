							...
							<div class="container" id="add_kamar_form">
								<div class="card card-success">
									...
									<div class="card-block row" style="background-color: #f4f4f4">
										...
										<div class="form-group">
											<label for="exampleInputEmail1">Nama / No. Kamar</label>
											<input type="text" class="form-control boxed form-control-sm" id="exampleInputEmail1" placeholder="">
										</div>
										<div class="form-group">
											<label class="control-label">Kelas Kamar</label>
											<select class="form-control boxed form-control-sm">
									...
									<div class="col-6">
										...
										<div class="form-group">
											<label for="exampleInputEmail1">Tarif/Hari</label>
											<input type="text" class="form-control boxed form-control-sm" id="exampleInputEmail1" placeholder="">
										</div>
										<div class="form-group">
											<label for="exampleInputEmail1">Keterangan</label>
											<input type="text" class="form-control boxed form-control-sm" id="exampleInputEmail1" placeholder="Keterangan">
										</div>
									</div>
										<div class="container form-group"  style="float: right;">
											<button type="button" class="btn btn-primary d_pasien-button">Simpan</button>
											<button type="button" class="btn btn-danger d_pasien-button"><a href="http://localhost:8080/com.rsia.modura/Kamar/list"/>Batal</a></button>
