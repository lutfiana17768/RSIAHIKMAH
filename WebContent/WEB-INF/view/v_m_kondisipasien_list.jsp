                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-block">
                                        ...
                                        <a href="http://localhost:8080/com.rsia.modura/Kondisi/tambah"/><button class="btn btn-primary">Tambah Data</button></a>
                                        ...
                                        <section class="example">
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered table-hover">
                                                    <thead>
                                                        <tr>
                                                            <th>Nama Kondisi Pasien</th>
                                                            <th>Keterangan</th>
                                                            <th colspan=2>Action</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <c:forEach var="tempKondisiPasien" items="${KondisiPasien}">
                                                        	<tr>
                                                        		<td> ${tempKondisiPasien.KondisiPasienNama } </td>
                                                        		<td> ${tempKondisiPasien.KondisiPasienKeterangan } </td>
                                                        	</tr>
                                                        </c:forEach>
                                                    </tbody>
                                                </table>
