								...
								<div class="card card-success">
									...
									<div class="card-block row" style="background-color: #f4f4f4">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control boxed form-control-sm" id="exampleInputEmail1" placeholder="Nama / No. Ruangan">
										</div>
										<div class="form-group">
									...
									<div class="col-6">
										...
										<a href="http://localhost:8080/com.rsia.modura/Ruang/list"/><button class="btn btn-primary">Batal</button></a>
										</div>
									</div>
								</div>
							</div>
