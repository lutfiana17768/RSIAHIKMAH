                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-block">
                                        ...
                                        <button class="btn btn-primary"><a href="http://localhost:8080/com.rsia.modura/Kelas/tambah"/>Tambah Data</a></button>
                                        ...
                                        <section class="example">
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered table-hover">
                                                    ...
                                                    <tbody>
                                                       <c:forEach var="tempkelas" items="${kelas}">
                                                        	<tr>
                                                        		<td> ${tempkelas.kelas_kode} </td>
                                                        		<td> ${tempkelas.kelas_nama } </td> 
