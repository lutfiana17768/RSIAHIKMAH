...
<head>
	<title>Pelayanan - List Pendaftaran Pasien RI</title>
...
<body>
	<div class="main-wrapper">
		<div class="app" id="app">
			<header class="header">
				<div class="nav-title">
					<h3 class="title">Pelayanan</h3><small>List Pendaftaran Pasien RI</small>
				</div>
								...
								<div class="card card-success">
									<div class="card-header" style="min-height:0">
										<div class="header-block" style="padding: 5px 20px">
											<p class="title"> List Pendaftaran Pasien RI </p>
										</div>
									</div>
											...
											<table class="table table-striped table-bordered table-hover">
												...
												<tbody>
													<tr>
														...
														<td>Mawar</td>
														<td>Daftar</td>
														<td><a href="#" style="color: blue"><span class="fa fa-pencil"></span></a></td>
														<td><a href="#" style="color: red"><span class="fa fa-trash-o"></span></a></td>
													</tr>
													<tr>
														<td>02/22/Dewasa</td>
														<td>Dani W.</td>
