...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
		...
		$(document).ready(function(){
			$("#add_kelas").click(function(){
			    $("#add_kelas_form").slideToggle('slow');
			});
		});
		</script>
</head>
							...
							<div class="col-md-6">
								<div class="card card-block sameheight-item">
									<div class="title-block">
										<h3 class="title"> Master Kelas </h3>
									</div>
									<form role="form">
										<div class="form-group">
											<label for="exampleInputEmail1">Nama Kelas</label>
											<input type="text" class="form-control boxed" id="exampleInputEmail1" placeholder="Masukan Nama Kelas"> </div>
										<div class="form-group">
											<label for="exampleInputPassword1">Keterangan</label>
											<input type="text" class="form-control boxed" id="exampleInputPassword1" placeholder="Masukan Keterangan"> </div>
										<div class="form-group">
											<button type="submit" class="btn btn-primary">Simpan</button>
											<button type="button" class="btn btn-danger d_pasien-button"><a href="http://localhost:8080/com.rsia.modura/Kelas/list"/>Batal</a></button>
