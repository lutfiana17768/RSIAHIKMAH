						...
						<div class="row sameheight-container">
							...
							<div class="col-md-6">
								<div class="card card-block sameheight-item">
									...
									<form:form modelAttribute="kelasModel" method="POST" action="../store">
                                        ...
                                        <section class="example">
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered table-hover">
                                                    ...
                                                    <tbody>
                                                        <c:forEach var="temp" items="${kelas}">
                                                        <c:choose>
                                                        	<c:when test="${temp.kelas_aktif  == 'Y' }">
	                                                        	<c:url var="updateLink" value="../form-update">
	                                                        		<c:param name="Id" value="${temp.kelas_id}" />
	                                                        	</c:url>
	                                                        	<c:url var="deleteLink" value="../delete">
	                                                        		<c:param name="Id" value="${temp.kelas_id}" />
	                                                        	</c:url>
	                                                        	<tr>
	                                                        		<td> ${temp.kelas_kode } </td>
	                                                        		<td> ${temp.kelas_nama } </td>
	                                                        		<td> ${temp.kelas_keterangan } </td>
