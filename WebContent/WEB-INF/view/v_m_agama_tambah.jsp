							...
							<div class="col-md-6">
								<div class="card card-block sameheight-item">
									<div class="title-block">
										<h3 class="title"> Master Agama </h3>
									</div>
									 
									<form action="../Agama/simpan" method="POST">	
										<div class="form-group">
											<label for="namaagama">Nama Agama</label> 
											<input  name="agamaNama" placeholder="Masukan Nama Agama"  class="form-control boxed" type="text"> 
										</div>
										<div class="form-group">
											<label for="keterangan">Keterangan</label>
											<input  class="form-control boxed" name="agamaKeterangan" placeholder="Masukan Keterangan" type="text"> 
										</div>
										<div class="form-group">
											<button type="submit" class="btn btn-primary">Simpan</button>
											 <a href="http://localhost:8080/com.rsia.modura/Agama/list"/><button class="btn btn-primary">Batal</button></a>
										</div>
									</form>
								</div>
							</div>
