										...
										<div class="sidebar-container">
											...
											<nav class="menu">
												<ul class="sidebar-menu metismenu" id="sidebar-menu">
													...
													<security:authorize access="hasAnyRole('ROLE_ADMIN','ROLE_APOTEK')">
														<li>
															<a href="">
																<i class="fa fa-desktop"></i> Farmasi
																<i class="fa arrow"></i>
															</a>
															<ul class="sidebar-nav">
																...
																<li>
																	...
																	<ul class="sidebar-nav collapse" aria-expanded="false">
																		...
																		<li>
																			<a href="/laporan"> laporan expired </a>
																		</li>
																		<li>
																			<a href="/kartu-stok"> kartu stok </a>
																		</li>
																	</ul>
																</li>
															</ul>
													...
													<security:authorize access="hasAnyRole('ROLE_ADMIN','ROLE_KASIR')">
														<li>
															<a href="">
																<i class="fa fa-desktop"></i> Rekam Medis
																<i class="fa arrow"></i>
															</a>
															<ul class="sidebar-nav">
																<li>
																	...
																	<ul class="sidebar-nav collapse" aria-expanded="false">
																		<li>
																			<a href="/kamar">Master Kamar</a>
																			<li>
																				<a href="/kelas">Master Kelas</a>
																				<li>
																					<a href="/kondisi">Master Kondisi Pasien</a>
																					<li>
																						<a href="/paket">Master Paket</a>
																						<li>
																							<a href="/pasien">Master Pasien</a>
																							<li>
																								<a href="/penunjang">Master Penunjang</a>
																								<li>
																									<a href="/penunjang-group">Master Penunjang Group</a>
																									<li>
																										<a href="/ruangan">Master Ruangan</a>
																										<li>
																											<a href="/tindakan">Master Tindakan</a>
																											<li>
																												<a href="/rujukan">Master Rujukan</a>
																	</ul>
																	</li>
																	<li>
																		<a href=""> Transaksi
																		...
																		<ul class="sidebar-nav collapse" aria-expanded="false">
																			...
																			<li>
																				<a href="/history"> History pasien</a>
																			</li>
																		</ul>
																	</li>
															</ul>
													...
													<security:authorize access="hasAnyRole('ROLE_ADMIN','ROLE_PENGGAJIAN')">
														<li>
															<a href="">
																<i class="fa fa-desktop"></i> Penggajian
																<i class="fa arrow"></i>
															</a>
															<ul class="sidebar-nav">
																<li>
													...
													<security:authorize access="hasRole('ROLE_ADMIN')">
														<li>
															<a href="">
																<i class="fa fa-desktop"></i> Master Pelengkap
																<i class="fa arrow"></i>
															</a>
															<ul class="sidebar-nav">
																<li>
																	<a href="/user">Master User</a>
																	<li>
																		<a href="/agama">Master Agama</a>
																		<li>
