								...
								<div class="card card-block sameheight-item">
									...
									<form action="../store" method="POST">		
										<div class="form-group">
											...
											<input class="form-control" name="kotaKode" id="exampleInputEmail1" placeholder="Masukan Kode Kota" type="text">
											</div>
										<div class="form-group">
											<label for="exampleInputPassword1">Nama Kota</label>
											<input class="form-control" name="kotaName" id="exampleInputPassword1" placeholder="Masukan Nama Kota" type="text">
										</div>
										<div class="form-group">
											<label for="exampleInputPassword1">Nama Provinsi</label>
											<div class="select2-wrapper">
												<select class="form-control input-lg select2-single" dir="rtl" name="propinsiKode">
													<option></option>
													<c:forEach var="tempProvinsi" items="${provinsi}">
			                                         	<option value=${tempProvinsi.propinsiKode }> ${tempProvinsi.propinsiNama } </option>
			                                         </c:forEach>
												</select>
											</div>
                                         </div>
                                                    ...
                                                    <tbody>
                                                        <c:forEach var="tempKota" items="${kota}">
                                                        	<c:url var="updateLink" value="../form-update">
                                                        		<c:param name="kotaId" value="${tempKota.kota_id}" />
                                                        	</c:url>
