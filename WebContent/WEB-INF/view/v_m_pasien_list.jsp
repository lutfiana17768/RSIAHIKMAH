												...
												<tbody>
													<c:forEach var="tempPasien" items="${Pasien}">
                                                        	<tr>
                                                        		...
                                                        		<td> 
                                                        			<a class="btn btn-warning" href="http://localhost:8080/com.rsia.modura/Pasien/delete/?Id=${tempPasien.pasien_id}">Delete</a>
                                                              		<a class="btn btn-info" href="http://localhost:8080/com.rsia.modura/Pasien/form-update/?Id=${tempPasien.pasien_id}">Update</a>
                                                        	</tr>
                                                        </c:forEach>
												</tbody>
											</table>
