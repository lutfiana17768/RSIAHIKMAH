						...
						<div class="container">
							...
							<div class="container">
								<div class="card card-success">
									...
									<button class="btn btn-primary"><a href="http://localhost:8080/com.rsia.modura/Kamar/tambah"/>Tambah Data</a></button>
										...
										<div class="table-responsive">
											<table class="table table-striped table-bordered table-hover">
												...
												<tbody>
												<c:forEach var="tempKamar" items="${kamar}">
                                                        	<tr>
                                                        		<td> ${tempKamar.kamar_no} </td>
                                                        		<td> ${tempKamar.m_kelas_id } </td>
                                                        		<td> ${tempKamar.kamar_keterangan } </td> 
                                                        		<td> ${tempKamar.m_kelas_id } </td>
                                                        		<td> ${tempKamar.kamar_keterangan } </td> 
