								...
								<div class="card card-block sameheight-item">
									...
									<form action="../store" method="POST">		
										<div class="form-group">
											...
											<input class="form-control" name="kecamatanKode" id="exampleInputEmail1" placeholder="Masukan Kode Kota" type="text">
											</div>
										<div class="form-group">
											<label for="exampleInputPassword1">Nama Kecamatan</label>
											<input class="form-control" name="kecamatanName" id="exampleInputPassword1" placeholder="Masukan Nama Kota" type="text">
										</div>
										<div class="form-group">
											<label for="exampleInputPassword1">Nama Kota</label>
											<div class="select2-wrapper">
												<select class="form-control input-lg select2-single" dir="rtl" name="kotaKode">
													<option></option>
                                                    ...
                                                    <tbody>
                                                        <c:forEach var="tempKecamatan" items="${kecamatan}">
	                                                       	<c:url var="updateLink" value="../form-update">
	                                                       		<c:param name="kecamatanId" value="${tempKecamatan.kecamatan_id}" />
	                                                       	</c:url>
