...
$('#simpan-detail').click(function(){
    ...
    nama_barang = $('#terimaDetailBarangNama').val();
    satuan = $('#terimaDetailSatuanId').val();
    jumlah = $('#terimaDetailJumlah').val() || 0;
    harga = $('#terimaDetailHarga').val() ||0;
    sub_total = $('#terimaDetailSubTotal').val() || 0;
    
    tr.append('<td data-used="1" data-save="1" data-name="terimaDetailBarangNama" data-kolom-id="barang">'+nama_barang+'</td>');
    tr.append('<td data-used="1" data-save="1" data-name="terimaDetailSatuanId" data-kolom-id="satuan">'+satuan+'</td>');
