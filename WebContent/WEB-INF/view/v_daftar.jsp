		...
		<div class="main-wrapper">
			<div class="app" id="app">
				...
				<article class="content forms-page">
					<div class="row">
						<div class="col-6">
							<a href="v_daftar_rj.html">
								<div style="padding:200px 0" class="btn btn-success-outline col-12">
									Rawat Jalan
								</div>
							</a>
						</div>
						<div class="col-6">
							<a href="v_daftar_ri.html">
								<div style="padding:200px 0" class="btn btn-info-outline col-12">
									Rawat Inap
								</div>
							</a>
						</div>
