...
<body>
				...
				<div class="col-12" id="add_paket_form">
                     <div class="card card-success">
                         ...
                         <div class="card-block row" style="background-color: #f4f4f4">
                             <div class="col-4">
    							<form:form modelAttribute="paketModel" method="POST"
    								action="store" id="paket-form">
                                             ...
                                             <div class="tab-content">
                                                     ...
                                                     <div class="container-fluid" style="padding:0">
                                                         <div class="card-header card-header-sm bordered" style="background-color: #f0f0f0">
                                                             <div class="header-block">
                                                                 <button type="button" id="add_ruang" class="btn btn-success btn-sm">Tambah</button>
                                                             </div>
                                                         </div>
                                                 ...
                                                 <div role="tabpanel" class="tab-pane fade" id="tindakan">
                                                     <div class="container-fluid" style="padding:0">
                                                         <div class="card-header card-header-sm bordered" style="background-color: #f0f0f0">
                                                             <div class="header-block">
                                                                 <button type="button" id="add_tindakan" class="btn btn-success btn-sm">Tambah</button> 
                                                             </div>
                                                         </div>
                                                         <div class="card-block" style="background-color: #f4f4f4">
                                                             <div class="table-responsive" style="overflow-y: auto;">
                                                                 ...
                                                                 <table class="table table-striped table-bordered table-hover">
                                                                     ...
                                                                     <tbody>
                                                                         <tr>
                                                                             ...
                                                                             <td>Table cell</td>
                                                                             <td>Table cell</td>
                                                                             <td> <button type="button" class="btn btn-danger btn-sm">Delete</button>&nbsp
                                                 ...
                                                 <div role="tabpanel" class="tab-pane fade" id="obatalkes">
                                                     <div class="container-fluid" style="padding:0">
                                                         <div class="card-header card-header-sm bordered" style="background-color: #f0f0f0">
                                                             <div class="header-block">
                                                                 <button type="button" class="btn btn-success btn-sm" id="add_barang">Tambah</button> 
                                                             </div>
                                                         </div>
                                                         <div class="card-block" style="background-color: #f4f4f4">
                                                             <div class="table-responsive" style="overflow-y: auto;">
    ...
    <jsp:include page="scriptpaketadd.jsp"></jsp:include>
