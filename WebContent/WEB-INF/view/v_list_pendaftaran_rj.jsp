...
<head>
	<title>Pelayanan - List Pendaftaran Pasien RJ</title>
...
<body>
	<div class="main-wrapper">
		<div class="app" id="app">
			<header class="header">
				<div class="nav-title">
					<h3 class="title">Pelayanan</h3><small>List Pendaftaran Pasien RJ</small>
				</div>
								...
								<div class="card card-success">
									<div class="card-header" style="min-height:0">
										<div class="header-block" style="padding: 5px 20px">
											<p class="title"> List Pendaftaran Pasien RJ </p>
										</div>
									</div>
