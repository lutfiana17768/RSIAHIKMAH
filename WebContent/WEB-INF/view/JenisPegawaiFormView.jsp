							...
							<div class="col-md-6">
								<div class="card card-block sameheight-item">
									<div class="title-block">
										<h3 class="title"> Data Jenis Pegawai </h3>
									</div>
									<form action="http://localhost:8080/com.rsia.modura/provinsi/store" method="POST">		
										<div class="form-group">
											<label for="exampleInputEmail1">Kode Jenis Pegawai</label>
											<input class="form-control" name="jenispegawai_kode" id="exampleInputEmail1" placeholder="Masukan Kode Jenis Pegawai" type="text">
											</div>
										<div class="form-group">
											<label for="exampleInputPassword1">Nama Jenis Pegawai</label>
											<input class="form-control" name="jenispegawai_nama" id="exampleInputPassword1" placeholder="Masukan Jenis Pegawai" type="text">
										</div>
										<div class="form-group">
											<label for="exampleInputPassword1">Sub Dari</label>
											<div class="select2-wrapper">
												<select class="form-control input-lg select2-single" dir="rtl">
													<option></option>
													<c:forEach var="tempKota" items="${kota}">
			                                         	<option value=${tempKota.kotaKode }> ${tempKota.kotaNama } </option>
			                                         </c:forEach>
			                                         <c:forEach var="tempJenisPegawai" items="${jenisPegawai}">
                                                        <option value=${tempJenisPegawai.jenispegawai_kode }> ${tempJenisPegawai.jenispegawai_nama } </option>
                                                        </c:forEach>
												</select>
											</div>
                                         </div>
                                         <div class="form-group">
											...
											<textarea class="form-control" name="jenispegawai_keterangan" id="exampleInputPassword1" placeholder="Masukan Keterangan"> </textarea>
										</div>
										<div class="form-group">
                                ...
                                <div class="card">
                                    <div class="card-block">
                                        <div class="card-title-block">
                                            <h3 class="title"> List Jenis Pegawai </h3>
                                        </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered table-hover">
                                                    ...
                                                    <tbody>
                                                        <c:forEach var="tempJenisPegawai" items="${jenisPegawai}">
                                                        	<tr>
                                                        		<td> ${tempJenisPegawai.jenispegawai_kode } </td>
                                                        		<td> ${tempJenisPegawai.jenispegawai_nama } </td>
                                                        		<td> ${tempJenisPegawai.jenispegawai_keterangan } </td>
                                                        	</tr>
                                                        </c:forEach>
                                                    </tbody>
                                                </table>
