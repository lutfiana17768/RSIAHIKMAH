                            ...
                            <tbody id="pelayanan-diagnosapasien-list" class="table-form">
                            	<c:forEach var="dp" items="${pelayananModel.diagnosapasien}" varStatus="loop">
									<tr id="diagnosapasien_${loop.index+1}">
                                            <td data-used="1" data-save="1" data-name="diagnosapasien_icd" data-kolom-id="diagnosapasien_icd">${diagnosapasien_icd}</td>
                                            <td data-used="1" data-save="1" data-name="diagnosapasien_nama" data-kolom-id="diagnosapasien_nama">${dp.m_icd_id}</td>
