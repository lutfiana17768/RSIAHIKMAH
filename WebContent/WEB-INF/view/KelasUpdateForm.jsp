						...
						<div class="row sameheight-container">
							...
							<div class="col-md-6">
								<div class="card card-block sameheight-item">
									...
									<form:form modelAttribute="kelasModel" method="POST" action="update">
										<form:hidden path="kelas_id" />
										
										<div class="form-group">
											<label for="exampleInputPassword1">Kode</label>
											<form:input path="kelas_kode" class="form-control"/>
										</div>
										
										<div class="form-group">
											<label for="exampleInputPassword1">Nama</label>
											<form:input path="kelas_nama" class="form-control"/>
										</div>
										<div class="form-group">
											<label for="exampleInputPassword1">Keterangan</label>
											<form:input path="kelas_keterangan" class="form-control"/>
										</div>
