		...
		<div class="row sameheight-container">
			...
			<div class="col-md-6">
				<div class="card card-block sameheight-item">
					...
					<form:form modelAttribute="pegawaiModel" method="POST" action="store">		
						...
						<div class="form-group input-group date" data-provide="datepicker">
							<label  for="form_control_1">Tanggal Lahir</label>
			                	<form:input path="pegawaiTglLahir" placeholder="Masukan Tanggal Lahir" class="form-control" />
						...
						<div class="form-group">
			                ...
			                <form:input path="pegawaiTglMasuk" class="form-control" placeholder="Masukan Tanggal Masuk" />
						</div>
						
						<div class="form-group">
							<label  for="form_control_1">Tanggal Keluar</label>
							<form:input path="pegawaiTglKeluar" class="form-control" placeholder="Masukan Tanggal Keluar" />
						</div>
