                    ...
                    <section class="section">
                        <div class="container">
                            <div class="row">
                                <div class="col-6">
                                    <small>Keterangan :
                                        <span style="color:red">*</span> Wajib Diisi</small>
                                </div>
                                <div class="col-6">
                                        ...
                                        <div class="container">
                                            <div class="card card-success">
                                                ...
                                                <div class="card-block" style="background-color: #f4f4f4">
                                                    <button type="button" class="btn btn-sm btn-success" style="float: right;" id="add_order" data-toggle="modal" data-target="#form-detail">
                                                            ...
                                                            <tbody id="order-list" class="table-form"><c:forEach var="odet" items="${orderModel.detail}" varStatus="loop">
                                                                <tr id="order_${loop.index+1}">
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <button type="button" class="btn btn-primary btn-sm" onclick="editOrder(${loop.index+1})">Edit</button>
                                                                    </td>
                                                                    <td style="display:none" data-used="1" data-save="1" data-name="orderDetailId" data-kolom-id="orderDetailId">${odet.orderDetailId}</td>
                                                                </tr>
                                                            </c:forEach>
