						...
						<div class="row sameheight-container">
							...
							<div class="col-md-6">
								<div class="card card-block sameheight-item">
									...
									<form:form modelAttribute="pegawaiModel" method="POST" action="update">		
										...
										<div class="form-group">
											<label  for="form_control_1">No Pegawai</label>
							                	<form:input path="pegawaiNo" class="form-control" />
										</div>
			
										<div class="form-group">
											<label  for="form_control_1">Nama Pegawai</label>
							                	<form:input path="pegawaiNama" class="form-control"  />
										</div>
										...
										<div class="form-group">
											...
											<div class="select2-wrapper">
												<form:select path="tempatLahirId" class="form-control input-lg select2-single" >
													<option></option>
										...
										<div class="form-group">
											...
											<form:input path="pegawaiAlamat" class="form-control" />
										</div>
										...
										<div class="form-group">
							                ...
							                <form:input path="pegawaiEmail" class="form-control" />
										</div>
										
										<div class="form-group">
											<label  for="form_control_1">Nomer HP</label>
							                <form:input path="pegawaiNoHp" class="form-control" />
										</div>
										...
										<div class="form-group">
											<label  for="form_control_1">Akun Bank</label>
							                	<form:input path="pegawaiBankAkun" class="form-control" />
										</div>
										
										<div class="form-group">
											<label  for="form_control_1">Nomer Rekening</label>
							                	<form:input path="pegawaiBankRekening" class="form-control"  />
										</div>
