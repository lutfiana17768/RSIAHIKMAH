								...
								<div class="card card-block sameheight-item">
									...
									<form action="../store" method="POST">		
										<div class="form-group">
											...
											<input class="form-control" name="kelurahanKode" id="exampleInputEmail1" placeholder="Masukan Kode kecamatan" type="text">
											</div>
										<div class="form-group">
											<label for="exampleInputPassword1">Nama kelurahan</label>
											<input class="form-control" name="kelurahanName" id="exampleInputPassword1" placeholder="Masukan Nama kecamatan" type="text">
										</div>
										<div class="form-group">
											<label for="exampleInputPassword1">Nama Kecamatan</label>
											
											<div class="select2-wrapper">
												<select class="form-control input-lg select2-single" dir="rtl" name="kecamatanKode">
													<option></option>
													<c:forEach var="tempkecamatan" items="${kecamatan}">
			                                         	<option value=${tempkecamatan.kecamatanKode }> ${tempkecamatan.kecamatanNama } </option>
			                                         </c:forEach>
												</select>
											</div>
                                         </div>
                                                    ...
                                                    <tbody>
                                                        <c:forEach var="tempKelurahan" items="${kelurahan}">
                                                        	<c:url var="updateLink" value="../form-update">
                                                     			<c:param name="kelurahanId" value="${tempKelurahan.kelurahan_id}" />
                                                       		</c:url>
