                            ...
                            <div class="col-md-12">
                                <div class="card">
                                 <div class="card-block">
                                        ...
                                        <button class="btn btn-primary"><a href="http://localhost:8080/com.rsia.modura/Agama/tambah"/>Tambah Data</a></button>
                                        ...
                                        <section class="example">
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered table-hover">
                                                    ...
                                                    <tbody>
                                                        <c:forEach var="tempAgama" items="${agama}">
                                                        	<tr>
                                                        		<td> ${tempAgama.agamaNama } </td>
                                                        		<td> ${tempAgama.agamaKeterangan } </td>
