			...
			<div class="app" id="app">
				...
				<article class="content forms-page">
					<section class="section">
						<div class="container">
							<div class="container" id="add_tindakan_form" style="display: none">
									...
									<div class="row card-block" style="background-color: #f4f4f4;margin:0;">
										<div class="col-6">
											<div class="form-group">
												<label class="control-label">Jenis Tindakan<span style="color:red">*</span></label>
											...
											<div class="form-group">
												<label for="exampleInputEmail1">Nama Tindakan<span style="color:red">*</span></label>
												<input type="text" class="form-control boxed form-control-sm" id="exampleInputEmail1" placeholder="">
											</div>
										...
										<div class="col-6">
											<div class="form-group">
												<label for="exampleInputEmail1">Jasa Pelayanan</label>
												<input type="text" class="form-control boxed form-control-sm" id="exampleInputEmail1" placeholder="">
											</div>
											<div class="form-group">
												<label for="exampleInputEmail1">Jasa Medik</label>
												<input type="text" class="form-control boxed form-control-sm" id="exampleInputEmail1" placeholder="">
											</div>
											<div class="form-group">
												<label for="exampleInputEmail1">Jasa Sarana</label>
												<input type="text" class="form-control boxed form-control-sm" id="exampleInputEmail1" placeholder="">
											</div>
											<div class="form-group">
							...
							<div class="container">
								<div class="form-group">
									<button type="button" class="btn btn-sm btn-primary" id="add_tindakan">Tambah</button>
								</div>
							</div>
							<div class="container">
								<div class="card card-success">
