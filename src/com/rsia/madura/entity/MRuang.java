...
public class MRuang {
	...
	private String ruang_deleted_by;
	...
	public String getRuang_deleted_by() {
		return ruang_deleted_by;
	}

	public void setRuang_deleted_by(String ruang_deleted_by) {
		this.ruang_deleted_by = ruang_deleted_by;
	}
}